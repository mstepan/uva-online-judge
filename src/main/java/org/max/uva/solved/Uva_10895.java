...
public class Uva_10895 {
    ...
    private Uva_10895() throws IOException, InterruptedException {
        ...
        try (BufferedReader rd = new BufferedReader(new InputStreamReader(in))) {
            ...
            while (true) {
                ...
                List<ColumnAndValue>[] transposed = buildTransposed(rd, rowsCnt, colsCnt);
    ...
    private static List<ColumnAndValue>[] buildTransposed(BufferedReader rd, int rowsCnt, int colsCnt) throws IOException {

        List<ColumnAndValue>[] transposed = new List[colsCnt];
        ...
        for (int row = 0; row < rowsCnt; ++row) {
            ...
            for (int posIndex = 1; posIndex < positions.length; ++posIndex) {
                ...
                if (transposed[listIndex] == null) {
                    transposed[listIndex] = new ArrayList<>();
                }
    ...
    private static void printTransposedMatrix(PrintStream out, int colsCnt, int rowsCnt, List<ColumnAndValue>[] transposed) {
